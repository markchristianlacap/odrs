...
namespace Backend.Migrations
{
    ...
    public partial class InitialMigration : Migration
    {
                ...
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        Section = table
                            .Column<string>(type: "longtext", nullable: false)
                            .Annotation("MySql:CharSet", "utf8mb4"),
                        ProgramId = table.Column<Guid>(
                            type: "char(36)",
                            nullable: false,
                            collation: "ascii_general_ci"
                        ),
                        CampusId = table.Column<Guid>(
                            type: "char(36)",
                            nullable: false,
                            collation: "ascii_general_ci"
                        ),
                        ...
                        ReleasedById = table.Column<Guid>(
                            type: "char(36)",
                            nullable: true,
                            collation: "ascii_general_ci"
                        ),
        ...
        {
            migrationBuilder.DropTable(name: "RequestHistories");

            migrationBuilder.DropTable(name: "RequestRequirements");
